...
{{--                <p>Почему мы, сервис по продаже и установке автостекла, именно те, кто Вам нужен?</p>--}}
        ...
        <div class="row">
            <div class="col-lg-6 order-1 order-lg-2">
                <img src="/landing_img/medium.jpg" class="img-fluid" alt="Autoglass House Logo">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                ...
                <ul>
                    ...
                    <li><i class="icofont-check-circled"></i> Купить автостекло в нашем интернет-магазине очень легко и
