...
{{--      </div>--}}
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.blade.php">Autoglass House</a></h1>
...
{{--              </div>--}}
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <label for="name">Текст обращения</label>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Autoglass House {{ date('Y') }}</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
          Designed by <a href="http://bereznii.me/">Me</a>
      </div>
    </div>
  </footer><!-- End Footer -->
